...
$after_assoc_aboutme = mysqli_fetch_assoc($select_aboutme_result);

// education
$select_education = "SELECT * FROM education";
$select_education_result = mysqli_query($db_connect, $select_education);
$after_assoc_education = mysqli_fetch_assoc($select_education_result);
...
// $after_assoc_works = mysqli_fetch_assoc($select_brand_result);
...
// $after_assoc_testimonial = mysqli_fetch_assoc($select_testimonial_result);
// print_r($select_testimonial_result);
// die();
...
$after_assoc_contacts = mysqli_fetch_assoc($select_contacts_result);
...
<head>
        ...
        <link rel="stylesheet" href="dashboard_assets/css/animate.min.css">
        <link rel="stylesheet" href="dashboard_assets/css/magnific-popup.css">
        <link rel="stylesheet" href="dashboard_assets/css/fontawesome-all.min.css">
        <link rel="stylesheet" href="dashboard_assets/css/flaticon.css">
        <link rel="stylesheet" href="dashboard_assets/css/slick.css">
        <link rel="stylesheet" href="dashboard_assets/css/aos.css">
        <link rel="stylesheet" href="dashboard_assets/css/default.css">
        <link rel="stylesheet" href="dashboard_assets/css/style.css">
        <link rel="stylesheet" href="dashboard_assets/css/responsive.css">
    </head>
    <body class="theme-bg">
        ...
        <main>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-7 col-lg-6">
                            <div class="banner-content">
                                <h6 class="wow fadeInUp" data-wow-delay="0.2s"><?= $after_assoc_banner['heading']?></h6>
                                <h2 class="wow fadeInUp" data-wow-delay="0.4s"><?= $after_assoc_banner['title']?></h2>
                                <p class="wow fadeInUp" data-wow-delay="0.6s"><?= $after_assoc_banner['details']?></p>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 pr-90">
                            <div class="section-title mb-25">
                                ...
                                <h2><?=$after_assoc_aboutme['title']?></h2>
                            </div>
                            <div class="about-content">
                                <p><?=$after_assoc_aboutme['description']?></p>
                                <h3>Education:</h3>
                            </div>
                            <!-- Education Item -->
                    ...
                    <?php foreach($select_services_result as $services){ ?>
						<div class="col-lg-4 col-md-6">
							<div class="icon_box_01 wow fadeInLeft" data-wow-delay="0.2s">
                                <i ><img width="50" src="uploads/services/<?=$services['image']?>" alt=""></i>
            ...
            <section id="portfolio" class="portfolio-area primary-bg pt-120 pb-90">
                <div class="container">
                    ...
                    <div class="row">
                    <?php foreach($select_works_result as $works){ ?>
                        <div class="col-lg-4 col-md-6 pitem">
                            <div class="speaker-box">
								<div class="speaker-thumb">
									<img src="uploads/works/<?=$works['image']?>" alt="img">
								</div>
								<div class="speaker-overlay">
									<span><?=$works['category']?></span>
									<h4><a href="portfolio-single.html"><?=$works['title']?></a></h4>
                            ...
                            <div class="testimonial-active">
                                ...
                                <div class="single-testimonial text-center">
                                    <div class="testi-avatar">
                                        <img src="uploads/testimonials/<?=$testimonial['image']?>" alt="img">
                                    </div>
                    ...
                    <div class="row brand-active">
                        ...
                        <div class="col-xl-2">
                            <div class="single-brand">
                                <img  height="50" src="uploads/band/<?=$brand['image']?>" alt="img">
                            </div>
                        </div>
                        <?php } ?>
                        <!-- <div class="col-xl-2">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            ...
                            <div class="contact-content">
                                <p><?=$after_assoc_contacts['contact_information']?></p>
                                <h5>OFFICE IN <span><?=$after_assoc_contacts['place']?></span></h5>
                                <div class="contact-list">
                                    <ul>
                                        <li><i class="fas fa-map-marker"></i><span>Address :</span><?=$after_assoc_contacts['address']?></li>
                                        <li><i class="fas fa-headphones"></i><span>Phone :</span><?=$after_assoc_contacts['phone']?></li>
                                        <li><i class="fas fa-globe-asia"></i><span>e-mail :</span><?=$after_assoc_contacts['email']?></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
		...
		<!-- JS here -->
        <script src="dashboard_assets/js/vendor/jquery-1.12.4.min.js"></script>
        <script src="dashboard_assets/js/popper.min.js"></script>
        <script src="dashboard_assets/js/bootstrap.min.js"></script>
        <script src="dashboard_assets/js/isotope.pkgd.min.js"></script>
        <script src="dashboard_assets/js/one-page-nav-min.js"></script>
        <script src="dashboard_assets/js/slick.min.js"></script>
        <script src="dashboard_assets/js/ajax-form.js"></script>
        <script src="dashboard_assets/js/wow.min.js"></script>
        <script src="dashboard_assets/js/aos.js"></script>
        <script src="dashboard_assets/js/jquery.waypoints.min.js"></script>
        <script src="dashboard_assets/js/jquery.counterup.min.js"></script>
        <script src="dashboard_assets/js/jquery.scrollUp.min.js"></script>
        <script src="dashboard_assets/js/imagesloaded.pkgd.min.js"></script>
        <script src="dashboard_assets/js/jquery.magnific-popup.min.js"></script>
