                ...
                <div class="card">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <a href="banner_status.php?id=<?php echo $education['id'] ?>" class="btn btn-success">Active</a>    
                            <?php }  
                            
                             else{ ?>
                            <a href="banner_status.php?id=<?php echo $education['id'] ?>" class="btn btn-warning">Dective</a>    
                            <?php }  ?></td>
